class AMLadderASMenu extends AMLadder;
...
function NextPressed()
{
	...
	HideWindow();
	OB = ObjectiveBrowser(Root.CreateWindow(class'AMObjectiveBrowser', 100, 100, 200, 200, Root, True));
...
defaultproperties
{
	...
	LadderName="Assault"
	Ladder=Class'AMLadder.AMLadderAS'
